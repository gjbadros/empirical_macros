...
%token <node> SEMICOLON COMMA ELIPSIS
...
enum_type_define:  ENUM opt_tag LBRACE enum_def_list RBRACE
        {
            $1->type = TN_OBJ_DEF;
            $1->lnode = $2;
            $1->rnode = $4;
...
struct_type_define: STRUCT opt_tag LBRACE field_list RBRACE
        {
            $1->type = TN_OBJ_DEF;
            $1->lnode = $2;
            $1->rnode = $4;
...
union_type_define: UNION opt_tag LBRACE field_list RBRACE
        {
            $1->type = TN_OBJ_DEF;
            $1->lnode = $2;
            $1->rnode = $4;
...
comp_decl:  decl_specs comp_decl_list SEMICOLON
        {
...
param_type_list: param_list
               | param_list COMMA ELIPSIS        %prec COMMA_OP
        {
            $2->type = TN_PARAM_LIST;
            $2->lnode = $1;
            $2->rnode = $3;
            $$ = $2;
        }
...
direct_comp_select: postfix_expr DOT any_ident
        {
...
indirect_comp_select: postfix_expr ARROW any_ident
        {
